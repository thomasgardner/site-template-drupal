...
(0, _jquery2.default)(function () {
    var owl = (0, _jquery2.default)('.everything-carousel'),
        owlOptions = {
        autoHeight: true,
        nav: true,
        dots: false,
...
(0, _jquery2.default)(".search-button").click(function () {
    console.log("clicked");
    (0, _jquery2.default)("#searchInput").focus();
});

// init Masonry Social Wall
var $socialWall = (0, _jquery2.default)('.social-posts').masonry({
...
(0, _jquery2.default)(".profile-list, .fact-timeline, .job-posting-card-list").owlCarousel({
    margin: 30,
    nav: true,
    dots: false,
    items: 3,
...
(0, _jquery2.default)(".image-gallery-carousel").owlCarousel({
    margin: 6,
    autoHeight: true,
    dots: false,
    nav: true,
