...
$config = [
    ...
    'technicalcontact_email' => 'info@kwallcompany.com',
     ...
     */
    'secretsalt' => 'wsuJYi3gcx8ahKvMGuXLAiqsbKEztGtJdXFc',
     ...
     */
    'auth.adminpassword' => 'c6auAndYWV6KWA',
    ...
    'metadata.sources' => [
        array('type' => 'flatfile'),
        array('type' => 'flatfile', 'shib13-idp-remote.php'),
        array('type' => 'flatfile', 'saml20-idp-remote.php'),
        array('type' => 'flatfile', 'directory' => 'metadata/metadata-ucsc'),
    ],
