  ...
  Drupal.behaviors.flexSliderInit = {
    attach: function (context, settings) {
      ...
      $(document).ready(function () {
         ...
         * Hero Slideshow
        */
        $('.hero-slideshow', context).once('flexSliderInit').each(function () {
         ...
         * Interior Slideshow
        */
        $('.interior-slideshow', context).once('flexSliderInit').each(function () {
        ...
        */
        $('.featured-article-slider', context).once('flexSliderInit').each(function () {
        ...
        */
        $('.featured-events-slider', context).once('flexSliderInit').each(function () {
