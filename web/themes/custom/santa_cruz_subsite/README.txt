...
----------------------
 ...
 1. Setup the location for your new sub-theme.
    ...
    Copy the santa_cruz_subsite folder out of the zurb_foundation/ folder and rename it to
    ...
    For example, copy the themes/zurb_foundation/santa_cruz_subsite folder and
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the santa_cruz_subsite.info.yml.txt file to
    ...
    For example, rename the foo/santa_cruz_subsite.info.yml.txt file to foo/foo.info.yml.
 ...
 3. Edit your sub-theme to use the proper function names.
    ...
    First, rename santa_cruz_subsite.theme to include the name of your new sub-theme. In
    this example we'll assume that it's renamed foo.theme.

    Edit the foo.theme and theme-settings.php files in your sub-theme's
    folder; replace ALL occurrences of "santa_cruz_subsite" with the name of your
    sub-theme.

    For example, edit foo/foo.theme and foo/theme-settings.php and replace
    every occurrence of "santa_cruz_subsite" with "foo".
...
Optional steps:
 ...
 9. Add custom css and js files to your sub-theme
    ...
    Rename santa_cruz_subsite.libraries.yml to the name of your sub-theme, un-commenting
