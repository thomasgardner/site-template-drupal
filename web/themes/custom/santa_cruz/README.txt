...
----------------------
 ...
 1. Setup the location for your new sub-theme.
    ...
    Copy the santa_cruz folder out of the zurb_foundation/ folder and rename it to
    ...
    For example, copy the themes/zurb_foundation/santa_cruz folder and
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the santa_cruz.info.yml.txt file to
    ...
    For example, rename the foo/santa_cruz.info.yml.txt file to foo/foo.info.yml.
...
Optional steps:
 ...
 9. Add custom css and js files to your sub-theme
    ...
    Rename santa_cruz.libraries.yml to the name of your sub-theme, un-commenting
